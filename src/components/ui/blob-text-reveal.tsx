...
export type TextRevealBlurProps = {
  prefix?: string;
  texts?: string[];
  font?: FontStyle;
  color?: string;
...
const DEFAULT_TEXTS = ["HEALTHCARE BPO", "CONTACT CENTERS", "LIVE TRANSFERS", "DIGITAL GROWTH"];
...
const DEFAULT_WIPE_COLOR = "#DC2626";
const DEFAULT_REVEAL_COLOR = "#EF4444";
